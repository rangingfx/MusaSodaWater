        ...
        <div className="flex items-center justify-between">
            ...
            {navItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-4 py-2 text-xs font-bold uppercase tracking-[0.2em] transition-all duration-300 rounded-full cursor-pointer overflow-hidden group focus:outline-none ${
          ...
          <div className="hidden md:flex items-center">
            <button
              ...
              className="relative inline-flex items-center justify-center p-0.5 overflow-hidden text-xs font-bold uppercase tracking-widest rounded-full group bg-gradient-to-tr from-[#2dd4ff] to-[#46f08a] hover:text-black focus:ring-2 focus:ring-[#2dd4ff] focus:ring-offset-2 focus:ring-offset-[#050a12] transition-all duration-500 cursor-pointer"
            >
              <span className="relative px-5 py-2 transition-all ease-in duration-500 bg-gray-950 rounded-full group-hover:bg-opacity-0 font-display">
                Become Partner
              </span>
            </button>
          </div>
